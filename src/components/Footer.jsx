        ...
        <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden id="Footer'>
            <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
                <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                    ...
                    <p className='text-gray-400 mt-4'>Building Dreams, Creating Homes - Your Vision, Our Mission</p>
                </div>
                <div className='w-full md:w-1/5 mb-8 md:mb-0'>
                    ...
                    <ul className='flex flex-col gap-2 text-gray-400'>
                        ...
                        <a href="#Contact" className='hover:text-white'>ContactUS</a>
            ...
            <div>
            <div className="border-t border-gray-800 mt-10 py-6 text-center text-gray-400">
                <p>&copy; {new Date().getFullYear()} Estate by Safin . All rights reserved.</p>
            </div>
            </div>
        </div>
    );
